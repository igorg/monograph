...
\section{Breve descrição do algoritmo}
Mostrar o algoritmo de langford e a complexidade para ambas as fases.

\section{Algumas melhorias propostas}
Votação, pares por instância e quicksort para o ranking.