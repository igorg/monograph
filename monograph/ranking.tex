...
Partindo dessa divisão, o tempo computacional do algoritmo é a soma dos tempos das etapas de obtenção das pontuações e de ordenação. A etapa de obtenção das pontuações é bem definida no algoritmo \emph{Tournament \ref{alg:tournament}}, enquanto, na etapa de ordenação, qualquer algoritmo de ordenação: \emph{mergesort}, \emph{quicksort}, para citar alguns; pode ser usado.
