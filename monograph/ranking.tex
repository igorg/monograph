...
Após o particionamento da base, o conjunto $S'$ é gerado a partir de produtos cartesianos:

\[S' \gets (S_0 \times S_1) \cup (S_1 \times S_0)\]

O meio convencional de solucionar o produto cartesiano é aninhar dois \emph{loops} como mostrado no algoritmo \ref{alg:cross-product}.
...
% \begin{algorithm}
%     \begin{algorithmic}
%         \STATE $S_{crossed} \gets \emptyset$
% 
%         \IF{$S_{\alpha} \neq \emptyset \wedge S_{\beta} \neq \emptyset$}
%             \FOR{$x \in S_{\alpha}$}
%                 \FOR{$y \in S_{\beta}$}
%                     \STATE $S_{crossed} \gets S_{crossed} \cup \{(x, y)\}$
%                 \ENDFOR
%             \ENDFOR
%         \ENDIF
% 
%         \STATE return $S_{crossed}$
% 
%         \caption{Produto cartesiano}
%         \label{alg:cross-product}
% 
