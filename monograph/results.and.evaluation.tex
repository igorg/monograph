...
\begin{figure}[h]
    ...
    \subfloat[Glass]{
        \label{fig:glass_j48}
        \includegraphics[width=0.5\textwidth]{img/glass_j48.eps}
    }

    \subfloat[Hepatitis]{
        \label{fig:hepatitis_j48}
        \includegraphics[width=0.5\textwidth]{img/hepatitis_j48.eps}
    }    
    \subfloat[Vehicle]{
        \label{fig:vehicle_j48}
        \includegraphics[width=0.5\textwidth]{img/vehicle_j48.eps}
    }
    
    \subfloat[Yeast]{
        \label{fig:yeast_j48}
        \includegraphics[width=0.5\textwidth]{img/yeast_j48.eps}
    }
...
\begin{figure}[h]
    ...
    \subfloat[Breast cancer]{
        ...
        \includegraphics[width=0.5\textwidth]{img/breast-cancer_naive-bayes.eps}
    }
    \subfloat[Glass]{
        \label{fig:glass_naive-bayes}
        \includegraphics[width=0.5\textwidth]{img/glass_naive-bayes.eps}
    }

    \subfloat[Hepatitis]{
        \label{fig:hepatitis_naive-bayes}
        \includegraphics[width=0.5\textwidth]{img/hepatitis_naive-bayes.eps}
    }    
    \subfloat[Vehicle]{
        \label{fig:vehicle_naive-bayes}
        \includegraphics[width=0.5\textwidth]{img/vehicle_naive-bayes.eps}
    }
    
    \subfloat[Yeast]{
        \label{fig:yeast_naive-bayes}
        \includegraphics[width=0.5\textwidth]{img/yeast_naive-bayes.eps}
    }
...
\begin{figure}[h]
    ...
    \subfloat[Breast cancer]{
        ...
        \includegraphics[width=0.5\textwidth]{img/breast-cancer_logistic.eps}
    }
    \subfloat[Glass]{
        \label{fig:glass_logistic}
        \includegraphics[width=0.5\textwidth]{img/glass_logistic.eps}
    }

    \subfloat[Hepatitis]{
        \label{fig:hepatitis_logistic}
        \includegraphics[width=0.5\textwidth]{img/hepatitis_logistic.eps}
    }    
    \subfloat[Vehicle]{
        \label{fig:vehicle_logistic}
        \includegraphics[width=0.5\textwidth]{img/vehicle_logistic.eps}
    }
    
    \subfloat[Yeast]{
        \label{fig:yeast_logistic}
        \includegraphics[width=0.5\textwidth]{img/yeast_logistic.eps}
    }
...
\begin{figure}[h]
    ...
    \subfloat[Breast cancer]{
        ...
        \includegraphics[width=0.5\textwidth]{img/breast-cancer_smo.eps}
    }
    \subfloat[Glass]{
        \label{fig:glass_smo}
        \includegraphics[width=0.5\textwidth]{img/glass_smo.eps}
    }

    \subfloat[Hepatitis]{
        \label{fig:hepatitis_smo}
        \includegraphics[width=0.5\textwidth]{img/hepatitis_smo.eps}
    }    
    \subfloat[Vehicle]{
        \label{fig:vehicle_smo}
        \includegraphics[width=0.5\textwidth]{img/vehicle_smo.eps}
    }
    
    \subfloat[Yeast]{
        \label{fig:yeast_smo}
        \includegraphics[width=0.5\textwidth]{img/yeast_smo.eps}
    }
