...
\mes{Fevereiro}
\ano{2012}
\titulo{Implantação e Avaliação de um Método de Ranking Baseado em Classificação}
...
\palavrasChave{IA, Aprendizado de máquina, Learning to Ranking, Ranking, Classificação}
\end{resumo}
